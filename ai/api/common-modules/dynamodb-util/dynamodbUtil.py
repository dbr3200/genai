...
def sort_page_in_dynamo(**kwargs):
    ...
    if kwargs.get("projection_expression"):
        dynamo_query_args["ProjectionExpression"] = kwargs["projection_expression"]
    ...
    sorted_dynamo_items[kwargs['dict_key']] = response_dynamo_items[new_offset: new_offset+kwargs.get('items_limit', None)]
